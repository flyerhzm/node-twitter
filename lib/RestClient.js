 ...
 * Verify credential.
 *
 * For information on acceptable parameters see the official <a href="https://dev.twitter.com/rest/reference/get/account/verify_credentials">Twitter documentation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.verifyCredentials = function(parameters, callback)
{
    this._validator.validateIncludeEntities(parameters);
    this._validator.validateSkipStatus(parameters);

    this._createGetRequest('account/verify_credentials', this._format, parameters, callback);
}
